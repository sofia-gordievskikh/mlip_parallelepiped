...
\title{Inner box search для MILP: коробка против параллелепипеда}
\author{черновик}
\date{}
...
\begin{abstract}
Короткий отчёт-черновик по эвристике inner box search. Сравниваем два способа
вписать область в допустимое множество LP-релаксации: axis-aligned коробку и
параллелепипед с повёрнутым базисом. Показываем, что на наклонной допустимой
области параллелепипед вписывается там, где куб уже несовместен.
\end{abstract}
